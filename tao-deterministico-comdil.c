...
int main(){
  ...
  dados1 = fopen("txt/tao-deterministico-comdil1.txt", "w");
  dados2 = fopen("txt/tao-deterministico-comdil2.txt", "w");
  dados3 = fopen("txt/tao-deterministico-comdil3.txt", "w");
  dados4 = fopen("txt/tao-deterministico-comdil4.txt", "w");
  dados5 = fopen("txt/tao-deterministico-comdil5.txt", "w");
  dados6 = fopen("txt/tao-deterministico-comdil6.txt", "w");
  dados7 = fopen("txt/tao-deterministico-comdil7.txt", "w");
  dados8 = fopen("txt/tao-deterministico-comdil8.txt", "w");
  dados9 = fopen("txt/tao-deterministico-comdil9.txt", "w");
  dados10 = fopen("txt/tao-deterministico-comdil10.txt", "w");
  h = 0.0005;
  Ncrit = 276;
...
double f1(double Nc, double Nd){
  return Nc * (a*Nc + b*Nd + 1 - (Nc+Nd)/K);
}

double g1(double Nc, double Nd){
  return  Nd * (c*Nc + d*Nd + 1 - (Nc+Nd)/K);
}
